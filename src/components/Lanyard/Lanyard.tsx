...
// const cardGLB = "/portfolio/card.glb";
...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 h-screen origin-right">
      <Canvas
        camera={{ position, fov }}
...
function Band({ maxSpeed = 50, minSpeed = 0 }: BandProps) {
  ...
  const offsetX = 4.6; // << Shift the entire lanyard to the right
